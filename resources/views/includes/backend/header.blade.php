...
<div class="header">
    ...
    <div class="header-left">
        <a href="{{route(name: 'dashboard')}}" class="logo">
            <img src="{{!empty(app(abstract: App\Settings\ThemeSettings::class)->logo) ? asset('storage/settings/'.app(App\Settings\ThemeSettings::class)->logo):asset('assets/img/logo.png')}}" alt="logo" width="40" height="40">
        </a>
    </div>
    <!-- /Logo -->
